...
<xsl:output method="html" indent="no"/>
    ...
    <xsl:template name="method-params-details">
        <div class="mdetail-params">
			...
			<strong>Throw exceptions:</strong>
			<ul>
        ...
        <div class="inheritance res-block">
            <pre class="res-block-inner">
                <xsl:for-each select="superClasses">
                    <a href="output/{className}.html" ext:member="" ext:cls="{className}"><xsl:value-of select="shortClassName"/></a><xsl:text disable-output-escaping="yes">&#x0D;</xsl:text>
